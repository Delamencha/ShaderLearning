...
public class MyGrid 
{
    ...
    public MyGrid(int width, int height, float cellSize, Vector3 originPosition)
    {
        ...
        for (int x = 0; x < gridArray.GetLength(0); x++)
        {
            ...
            {
                debugTextArray[x, y] = CreateWorldText(null, gridArray[x, y].ToString() , GetWorldPosition(x, y) + new Vector3(1,1,1) * cellSize * 0.5f, 20, Color.white, TextAnchor.MiddleCenter, TextAlignment.Left, 5000);
